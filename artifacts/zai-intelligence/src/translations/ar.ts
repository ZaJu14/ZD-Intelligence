export const ar = {
  ...
  aboutPage: {
    hero: {
      label: "نهجنا",
      title: "نبني أنظمة ذكاء اصطناعي تعمل في العالم الحقيقي.",
      subtitle:
        "لا عروض تقديمية فارغة، ولا خرائط طريق مبهمة. نصمم ونبني وننشر أنظمة أتمتة واستخبارات الذكاء الاصطناعي — ونبقى مسؤولين عن النتائج.",
    },
    whyExist: {
      heading: "لماذا نحن موجودون",
      p1: "تعرف معظم المؤسسات أن الذكاء الاصطناعي يمكنه مساعدتها. الجزء الصعب هو تحويل تلك المعرفة إلى نظام عمل — يتكامل مع البيانات الحقيقية ويتعامل مع الحالات الاستثنائية ويستمر في العمل بعد ستة أشهر من الإطلاق.",
      p2: "بُنيت ZD Intelligence لسد هذه الفجوة. نركز على طبقة التنفيذ: تصميم الأنظمة التي تناسب عملياتك وبناؤها بصرامة على مستوى الإنتاج ودعمها لفترة كافية لتُحدث فرقاً.",
      p3: "نعمل بالعربية والإنجليزية، عن بُعد أو في الموقع، مع مؤسسات من أي حجم. الثابت الوحيد هو تركيزنا الدائم على النتائج — لا على المخرجات المبهرة التي تتراكم الغبار.",
    ...
    cards: [
      {
        icon: "🎯",
        title: "مهمتنا",
        body: "جعل أتمتة الذكاء الاصطناعي عملية وقابلة للقياس ومفيدة فعلاً — للمؤسسات التي تريد نتائج لا ضجيجاً.",
      },
      {
        icon: "🔬",
        title: "منهجيتنا",
        body: "نبدأ من عملياتك لا من التكنولوجيا. كل نظام نبنيه مصمم حول بياناتك وقيودك وقدرة فريقك على استخدامه وصيانته.",
      },
      {
        icon: "🤝",
        title: "التزامنا",
        body: "نحن ممارسة في مرحلة مبكرة. لن نلفق دراسات الحالة أو نضخم بياناتنا. ندع عملنا يتحدث عن نفسه وهو ينمو.",
      },
    ],
    howWeOperate: {
      eyebrow: "كيف نعمل",
      heading: "عمل عن بُعد. قدرة عالمية.",
      items: [
        {
          icon: "🌐",
          title: "لا حدود جغرافية",
          desc: "نخدم العملاء عن بُعد عبر أي منطقة زمنية. إذا كانت لديك بيانات ومشكلة تريد حلها، فالموقع الجغرافي ليس قيداً.",
        },
        {
          icon: "🗣️",
          title: "العربية والإنجليزية",
          desc: "نعمل بطلاقة في كلتا اللغتين — في الاجتماعات وفي التوثيق وفي الأنظمة التي نبنيها.",
        },
        {
          icon: "⚡",
          title: "قادرون على العمل غير المتزامن",
          desc: "نتكيف مع إيقاع عملك. متابعات منظمة ومعالم واضحة وتواصل شفاف — دائماً.",
        },
      ],
    },
  },
